      ...
      <div class="modal-content app-surface">
        ...
        <div class="modal-body">
          <div v-if="lastOrder" class="alert alert-success">
            Order placed for {{ lastOrder.items }} item(s) totaling
            <i class="bi bi-coin align-middle"></i> {{ lastOrder.total }}. Remaining balance:
            <i class="bi bi-coin align-middle"></i> {{ lastOrder.remainingBalance }}.
          </div>
              ...
              <div class="checkout-wallet-row mt-3 pt-3 border-top border-secondary-subtle">
                <div>
                  ...
                  <div class="small text-body-secondary">
                    All shop purchases are paid from your user balance.
                  </div>
                </div>
                <div class="fw-semibold">
                  <i class="bi bi-coin align-middle"></i> {{ walletBalance }}
                </div>
              </div>
              <div v-if="!hasEnoughBalance" class="alert alert-warning small mt-3 mb-0">
                You need <i class="bi bi-coin align-middle"></i> {{ balanceShortfall }} more to
                place this order.
              </div>
            </div>
          </div>
